  ...
  return (
    <div className="conditions">
      ...
      <p>
        ...
        de produits proposés par [Votre Nom d'Entreprise] au consommateur.
      </p>
      ...
      <p>
        Le client a la possibilité de passer sa commande en ligne, à partir du
        catalogue en ligne, pour tout produit, dans la limite des stocks
        disponibles. Il devra ensuite suivre les instructions pour finaliser sa
        commande.
      </p>
      ...
      <p>
        ...
        [votre loi applicable]. En cas de litige, une solution amiable sera
        recherchée avant toute action judiciaire. À défaut, les tribunaux [votre
        juridiction compétente] seront seuls compétents.
      </p>
    </div>
  );
}
